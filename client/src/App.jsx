...
function App() {
  ...
  return (
    <div className={"App "+theme}>
      ...
      :
      <p className={"switch "}>sorry games aren't sopprted in <b>Dark Mode</b> yet!</p>
      }
      <Routes>
        ...
        {/* game routes */}
        <Route path = "/games/wordleish" element={""}></Route>
        <Route path = "/games/snake" element={<Game src="https://daniellescipio.github.io/snake/"/>}></Route>
        <Route path= "/games/memorycircles" element={<Game src="https://daniellescipio.github.io/memoryGame--colorCircles/"/>}/>
        <Route path = "/games/minesweeper" element={""}></Route>
